...
prob_nn <- read.table("./dos_more_2w_neuralnet_24h/roc_dos_more_2w_neuralnet_24h_mean.txt",sep="\t",header=T)
prob_rf <- read.table("./dos_more_2w_randomforest_24h/roc_dos_more_2w_randomforest_24h_mean.txt",sep="\t",header=T)
prob_xgb <- read.table("./dos_more_2w_xgboost_24h/roc_dos_more_2w_xgboost_24h_mean.txt",sep="\t",header=T)
...
rocplot <- "roc_dos_more_2w_24h_mean.pdf"
