...
prob_nn <- read.table("./outcome1_neuralnet_24h/roc_outcome1_neuralnet_24h_mean.txt",sep="\t",header=T)
prob_rf <- read.table("./outcome1_randomforest_24h/roc_outcome1_randomforest_24h_mean.txt",sep="\t",header=T)
prob_xgb <- read.table("./outcome1_xgboost_24h/roc_outcome1_xgboost_24h_mean.txt",sep="\t",header=T)
...
rocplot <- "roc_outcome1_24h_mean.pdf"
