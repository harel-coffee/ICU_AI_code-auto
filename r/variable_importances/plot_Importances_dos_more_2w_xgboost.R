...
imp <- read.table("./dos_more_2w_xgboost_24h/variable_importances_dos_more_2w_xgboost_24h_mean.txt",sep="\t",header=T)
...
file_name <- "variable_importances_dos_more_2w_xgboost_24h_mean.pdf"
