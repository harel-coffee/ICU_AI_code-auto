...
imp <- read.table("./outcome1_randomforest_24h/variable_importances_outcome1_randomforest_24h_mean.txt",sep="\t",header=T)
...
file_name <- "variable_importances_outcome1_randomforest_24h_mean.pdf"
