...
imp <- read.table("./outcome1_neuralnet_24h/variable_importances_outcome1_neuralnet_24h_mean.txt",sep="\t",header=T)
...
file_name <- "variable_importances_outcome1_neuralnet_24h_mean.pdf"
